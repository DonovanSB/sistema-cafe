import sys
import os
from PyQt5.QtWidgets import QFrame, QPushButton, QLabel, QGridLayout, QVBoxLayout, QHBoxLayout, QComboBox, QAction, QGraphicsDropShadowEffect
...
class MenuVisualizacion(QFrame):
    def __init__(self):
        ...
        self.sensores = ["Temperatura A","Humedad A","Temperatura 1","Humedad 1",
                        "Temperatura 2", "Humedad 2", "Temperatura 3", "Humedad 3",
                        "Temperatura 4", "Humedad 4", "Temperatura 5", "Humedad 5", "Humedad grano"]
