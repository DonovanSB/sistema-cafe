...
class Conexion(QWidget):
    def __init__(self, prefs):
        ...
        self.namesSensors = ["Hum Ambiente", "Temp Ambiente", "Irradiancia", "Velocidad", "Direccion", "Lluvia"]
        self.savedNames = ["humEnv","tempEnv","irrad", "speed", "direction", "rain"]
...
class SamplingTime(QWidget):
    def __init__(self, prefs):
        ...
        self.namesSensors = ["Ambiente", "Irradiancia", "Velocidad", "Direccion", "Lluvia"]
        self.savedNames = ["env", "irrad", "speed", "direction", "rain"]
        numSensors = len(self.namesSensors)
        labelsSensors = []
        for name in self.namesSensors:
            label = QLabel(name)
