...
class Conexion(QWidget):
    def __init__(self, prefs):
        ...
        self.namesSensors = ["Hum Ambiente", "Temp Ambiente", "Hum Zona 1","Temp Zona 1",
                            "Hum Zona 2","Temp Zona 2", "Hum Zona 3","Temp Zona 3",
                            "Hum Zona 4","Temp Zona 4","Hum Zona 5","Temp Zona 5",
                            "Humedad Grano"]
        self.savedNames = ["humEnv","tempEnv","hum1","temp1","hum2","temp2","hum3","temp3",
                           "hum4","temp4","hum5","temp5","humGrano"]
...
class SamplingTime(QWidget):
    def __init__(self, prefs):
        ...
        self.namesSensors = ["Ambiente", "Zona 1", "Zona 2", "Zona 3", "Zona 4", "Zona 5"]
        self.savedNames = ["env","env1","env2","env3","env4","env5"]
        numSensors = len(self.namesSensors)
        labelsSensors = []
        for name in self.namesSensors:
            label = QLabel(name)
