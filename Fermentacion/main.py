...
class Estacion(QMainWindow):
    ...
    def createWidgets(self):
        ...
        self.temperature1 = widgets.RoundedContainer(
            "Temp 1", "temperaturayellow.svg", "18.23 °C"
        )
        self.temperature2 = widgets.RoundedContainer(
            "Temp 2", "temperaturayellow.svg", "20.15 °C"
        )
        self.temperature3 = widgets.RoundedContainer(
            "Temp 3", "temperaturayellow.svg", "22.13 °C"
        )
        self.temperature4 = widgets.RoundedContainer(
            "Temp 4", "temperaturayellow.svg", "21.13 °C"
        )
        self.refractometer = widgets.RoundedContainerInput(
            "Brix", "refractometrosmall.png", "50.25 Bx"
        )
