...
class MenuVisualizacion(QFrame):
    def __init__(self):
        ...
        labelTitle.setStyleSheet(
            "background: #0d47a1; color: white; font: 20px; font-weight:bold;border-top-left-radius: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; margin:0px 0px 0px 0px"
        )
        labelTitle.setAlignment(Qt.AlignCenter)
